          ...
          {planLoading ? (
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs font-bold text-slate-500 dark:text-slate-500">
                Cobro mensual en Argentina vía Mercado Pago. Dudas: nahuel@seo-jump.ai.
              </p>
            </div>
          )}
        </div>
        ...
        {isAdmin && (
          <div className="bg-purple-950/30 rounded-2xl border-2 border-purple-700/50 p-6 space-y-4">
            ...
            <p className="text-sm font-bold text-slate-400">
              Asigná PRO o Agencia a un usuario por email. El pago automático vía Mercado Pago también activa PRO al confirmarse.
            </p>
            <input
              type="email"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-800 rounded-3xl border-2 border-red-300 dark:border-red-800 p-6 md:p-8 max-w-md w-full shadow-2xl space-y-5">
            ...
            <p className="text-xs font-bold text-slate-500 dark:text-slate-450">
              Esto no cancela una suscripción de Mercado Pago si la tuvieras activa — hacelo aparte en Mercado Pago o contactándonos. Para revocar el acceso a Google, andá a{" "}

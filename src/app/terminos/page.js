        ...
        <div className="space-y-8 text-sm leading-relaxed text-slate-300">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <p><strong className="text-white">Procesamiento de Pagos:</strong> Los pagos en Argentina se procesan de forma externa y segura a través de Mercado Pago. Los pagos internacionales pueden procesarse vía Stripe. SEO Jump no almacena ni tiene acceso a los datos de tus tarjetas de crédito o débito.</p>
              ...
              <p><strong className="text-white">Política de Cancelación:</strong> Podés cancelar tu suscripción en cualquier momento desde tu cuenta de Mercado Pago o escribiendo a nahuel@seo-jump.ai. Al cancelar, mantendrás el acceso Premium hasta finalizar el período facturado en curso.</p>

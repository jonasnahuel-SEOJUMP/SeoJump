        ...
        <div className="space-y-8 text-sm leading-relaxed text-slate-300">
          ...
          <div className="space-y-3">
            ...
            <p className="text-slate-400 bg-slate-800/50 border border-slate-700 rounded-xl p-4">
              <strong className="text-white">Importante:</strong> eliminar tu cuenta en SEO Jump no cancela automáticamente una suscripción de pago en Mercado Pago, si la tuvieras activa. Eso debés gestionarlo por separado en Mercado Pago o contactándonos.
            </p>
          </div>
